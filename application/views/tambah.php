          ...
          <div class="card card-login border-0" style="background-color:#ffffff;padding:50px 0;">
            <div class="card-body px-lg-5 py-lg-5" >
              ...
              <div class="text-center text-muted mb-4">
                ...
                <p style="color:white;">TAMBAH PRODUK</p>
                ...
                <?php echo form_error('varian'); ?>
              </div>
              <?php echo form_open_multipart(); ?>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group mb-3">
                      <label for="companyname" style="color:white;">Nama Produk</label>
                        <input class="form-control" placeholder="Nama Produk" type="text" name="productname" value="">
                    </div>
                    <div class="form-group mb-3">
                      <label for="companyname" style="color:white;">Harga</label>
                        <input class="form-control" placeholder="Harga" type="text" name="price" value="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group mb-3">
                      <label for="notes" style="color:white;">Deskripsi Produk</label>
                        <textarea style="height:125px" class="form-control" placeholder="Deskripsi Produk" name="productdescription" ></textarea>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group mb-3">
                      <label for="foto" style="color:white;">Foto</label>
                      <?php echo form_upload('foto', null, 'class="form-control" style="border-radius:5px;padding:4px;border:1px solid white"'); ?>
                  ...
                  <div class="col-md-6">
                  <div class="form-group mb-3">
                      <label for="category" style="color:white;">Kategori</label>
                  ...
                  <div class="col-md-6">
                    <div class="form-group mb-3">
                      <label for="address2" style="color:white;">Stok</label>
                        <input class="form-control" placeholder="Stok" type="text" name="stock"value="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group mb-3">
                      <label for="postalcode" style="color:white;">Berat</label>
                        <input class="form-control" placeholder="Berat" type="text" name="berat" value="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group mb-3">
                      <label for="Kondisi" style="color:white;">Kondisi</label>
                        <input class="form-control" placeholder="Kondisi" type="text" name="kondisi" value="">
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group mb-3">
                      <label for="Varian" style="color:white;">Varian (Isi dengan koma)</label>
                        <input class="form-control" placeholder="Varian" type="text" name="varian" value="">
                    </div>
                  </div>
                </div>
                <div class="text-center" style="margin-top:30px">
                  <button type="submit" class="btn my-2" style="background-color:#FF327B;color:white;">Tambah Produk</button>
                </div>
              </form>
            </div>
          </div>
