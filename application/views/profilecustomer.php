        ...
        <div class="col-lg-10 col-md-10">
          <div class="card card-login border-0" style="background-color:#ffffff;padding:50px 0;">
            <div class="card-body px-lg-5 py-lg-5" >
              ...
              <img  style="height:150px;border-radius:50%; border: 1px solid white;box-shadow: 0 0 4px 1px rgba(0, 0, 0, 0.2) !important;" src="<?= base_url().'public/profile/'.$this->session->foto?>" />
              <br>
							<h1 style="color:white;"><?= $this->session->nama ?></h1>
							</div>
              <div class="text-center text-muted mb-4">
							
                <p style="color:white;">PROFILE CUSTOMER</p>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group mb-3">
                      ...
                      <textarea style="height:210px" class="form-control" placeholder="Address 2" name="address2"><?=$address2?></textarea>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group mb-3">
