          ...
          <div class="card card-login border-0" style="background-color:#22215B;padding:50px 0;">
            <div class="card-body px-lg-5 py-lg-5" >
              ...
              <div class="text-center text-muted mb-4">
                ...
                <p style="color:white;">REGISTER AS CUSTOMER</p>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group mb-3">
                      ...
                      <?php echo form_upload('foto', null, 'class="form-control" style="border-radius:5px;padding:4px;border:1px solid white"', 'required'); ?>
                  ...
                  <div class="col-md-6">
                    <div class="form-group mb-3">
                      ...
                      <textarea style="height:127px" class="form-control" placeholder="Address 2" name="address2"></textarea>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group mb-3">
